...
#
# Created: Tue Dec 10 23:31:13 2019
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_file_out.setGeometry(QtCore.QRect(10, 230, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.button_file_out.setFont(font)
        self.button_file_out.setObjectName("button_file_out")
        self.label = QtWidgets.QLabel(self.groupBox_3)
        self.label.setGeometry(QtCore.QRect(40, 10, 351, 221))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_2.setGeometry(QtCore.QRect(40, 10, 351, 221))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_file_out.setText(QtWidgets.QApplication.translate("MainWindow", "Раскодировать", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("MainWindow", "Для правильной работы программы в папке приложения должны лежать файлы: text.txt (закодированные данные), key.pickle (ключ для расшифровки)", None, -1))
        self.button_file_in.setText(QtWidgets.QApplication.translate("MainWindow", "Закодировать", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("MainWindow", "Файлы text.txt (закодированные данные), key.pickle (ключ для расшифровки) будут лежать в папке приложения в случае успешной кодировки", None, -1))
