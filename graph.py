...
#
# Created: Tue Dec 10 23:03:42 2019
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_delete.setGeometry(QtCore.QRect(10, 150, 161, 41))
        self.button_delete.setObjectName("button_delete")
        self.groupBox_3 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(1100, 10, 431, 311))
        self.groupBox_3.setTitle("")
        self.groupBox_3.setObjectName("groupBox_3")
        self.button_file_out = QtWidgets.QPushButton(self.groupBox_3)
        self.button_file_out.setGeometry(QtCore.QRect(10, 250, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.button_file_out.setFont(font)
        self.button_file_out.setObjectName("button_file_out")
        self.line_file_URL = QtWidgets.QLineEdit(self.groupBox_3)
        self.line_file_URL.setGeometry(QtCore.QRect(120, 90, 301, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.line_file_URL.setFont(font)
        self.line_file_URL.setObjectName("line_file_URL")
        self.line_key_URL = QtWidgets.QLineEdit(self.groupBox_3)
        self.line_key_URL.setGeometry(QtCore.QRect(120, 170, 301, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.line_key_URL.setFont(font)
        self.line_key_URL.setObjectName("line_key_URL")
        self.label = QtWidgets.QLabel(self.groupBox_3)
        self.label.setGeometry(QtCore.QRect(120, 40, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.groupBox_3)
        self.label_2.setGeometry(QtCore.QRect(120, 120, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.groupBox_4 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_4.setGeometry(QtCore.QRect(1100, 320, 431, 311))
        self.groupBox_4.setTitle("")
        self.groupBox_4.setObjectName("groupBox_4")
        self.button_file_in = QtWidgets.QPushButton(self.groupBox_4)
        self.button_file_in.setGeometry(QtCore.QRect(10, 250, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.button_file_in.setFont(font)
        self.button_file_in.setObjectName("button_file_in")
        self.line_URL_code = QtWidgets.QLineEdit(self.groupBox_4)
        self.line_URL_code.setGeometry(QtCore.QRect(120, 160, 301, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.line_URL_code.setFont(font)
        self.line_URL_code.setObjectName("line_URL_code")
        self.line_name_list = QtWidgets.QLineEdit(self.groupBox_4)
        self.line_name_list.setGeometry(QtCore.QRect(120, 50, 301, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.line_name_list.setFont(font)
        self.line_name_list.setObjectName("line_name_list")
        self.label_3 = QtWidgets.QLabel(self.groupBox_4)
        self.label_3.setGeometry(QtCore.QRect(120, 10, 171, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.groupBox_4)
        self.label_4.setGeometry(QtCore.QRect(120, 110, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_delete.setText(QtWidgets.QApplication.translate("MainWindow", "Очистить список", None, -1))
        self.button_file_out.setText(QtWidgets.QApplication.translate("MainWindow", "Взять список", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("MainWindow", "Адресс файла", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("MainWindow", "Адресс ключа", None, -1))
        self.button_file_in.setText(QtWidgets.QApplication.translate("MainWindow", "Закодировать", None, -1))
        self.label_3.setText(QtWidgets.QApplication.translate("MainWindow", "Имя файла списка", None, -1))
        self.label_4.setText(QtWidgets.QApplication.translate("MainWindow", "Куда сохранить", None, -1))
